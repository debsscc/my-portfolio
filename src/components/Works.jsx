    ...
    <motion.div variants={fadeIn("up", "spring", index * 0.5, 0.75)}>
      <a href={source_code_link} target="_blank" rel="noopener noreferrer">
        <Tilt
          ...
          className="bg-black border border-green-400 p-5 rounded-2xl sm:w-[360px] w-full shadow-lg hover:scale-[1.02] transition-transform duration-300 min-h-[500px] flex flex-col justify-between"
        >
          ...
          <div className="mt-5">
            ...
            <p className="mt-2 text-green-200 text-[14px] font-mono min-h-[60px]">
              {description}
            </p>
          </div>
...
const Works = () => {
  ...
  >
    Conecte-se com minhas criações. Aqui estão missões concluídas,
    sistemas desenvolvidos, interfaces funcionais, APIs integradas, e
    soluções arquitetadas com precisão. Cada projeto é um log de
    progresso técnico e criativo no meu repositório de experiências.
  </motion.p>
</div>
